...
public class LiteratureController {
    ...
    public LiteratureController(LiteratureScreeningService literatureScreeningService) { this.literatureScreeningService = literatureScreeningService; }
    @PostMapping(value = "/screen", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public JsonNode screen(@RequestPart("files") List<MultipartFile> files) { return literatureScreeningService.screen(files); }
}
